...
const FoodItem = ({foodItems, filterByType, filterByPrice, allFoodItems}) => {
  ...
  return (
    <FoodItemContainer>
        <h1 className='text-red-600 font-bold text-2xl lg:text-4xl text-center mb-2'>New On The Menu</h1>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-4'>
            {
                foodItems.map ((item, index)=> (
                    <div key={index}  className='border shadow-lg rounded-lg hover:scale-105 cursor-pointer duration-300 '>
...
const FoodItemContainer = tw.div`
    w-full m-auto px-4 sm:px-40  mb-32
`;
