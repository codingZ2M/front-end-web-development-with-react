...
const Sneakers = () => {
  ...
  return (
    <SneakersContainer>
      <HeroBannerContainer>
        <img src="/images/sneakers/hero_img.jpg"/>
      </HeroBannerContainer>
      <h1 className='flex pl-8 font-normal text-xl mt-28 sm:mt-10 mb-2 sm:mb-6'>Sneakers</h1>
      <Promotion>
             <p className='text-4xl sm:text-7xl font-semibold'>SALE</p>
             <p className='text-xl sm:text-3xl'>15 to 30 JULY </p>
             <p className='text-xl sm:text-3xl'>SPORT SHOES </p>
...
const SneakersContainer = tw.div` 
  mt-0 w-full h-full mb-20 
`;
const HeroBannerContainer = tw.div`
  hidden sm:flex  justify-end mt-28 brightness-100 sm:pr-40
`;
